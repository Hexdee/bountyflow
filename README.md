...
BountyFlow is a marketplace for Web3 work. Project owners fund a bounty in XLM, builders apply and submit proof, and approval releases escrow while updating an on-chain reputation profile.
...
- Submission evidence: [docs/submission/README.md](docs/submission/README.md)
